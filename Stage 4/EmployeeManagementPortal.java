...
public class EmployeeManagementPortal {
    ...
    private ManageEmployeeSchedule manageEmployeeSchedule = new ManageEmployeeSchedule(employeeService);
    // Scanner for reading input from the console
    private final Scanner scanner = new Scanner(System.in);

    public EmployeeManagementPortal() {
        this.employeeService = new EmployeeService();
        this.manageEmployeeSchedule = new ManageEmployeeSchedule(employeeService);
    }
    /**
    ...
    public String createEmployee(String name, String address, String email, double salary) {
        try {
     ...
     */
    public void manageEmployeeSchedule() {
